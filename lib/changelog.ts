...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: {
      de: [
        "Die App gibt es jetzt auf Deutsch und Englisch. Die Sprache lässt sich in den Einstellungen unter „Sprache“ umstellen; beim ersten Besuch richtet sie sich nach der Browsersprache. Die Wahl gilt auch für die versendeten E-Mails.",
        "Alle 40 Aufgaben und alle 23 Achievements sind übersetzt: Titel, Beschreibung, Hinweise und die Namen der Testfälle.",
        "Die Seite ist auf daily-coding.dev umgezogen. Alte Links auf daily-coding.de funktionieren weiter und führen auf die deutsche Fassung.",
        "Impressum und Datenschutzerklärung gibt es ebenfalls auf Englisch. Maßgeblich bleibt die deutsche Fassung; die englische Seite weist darauf hin.",
        "Datums- und Zahlenangaben folgen der eingestellten Sprache: aus dem 4.9.2026 wird im Englischen 9/4/2026, aus 1.500 Punkten werden 1,500.",
      ],
      en: [
        "The app is now available in German and English. You can switch in the settings under \"Language\"; on a first visit it follows your browser. The choice applies to the emails you get, too.",
        "All 40 challenges and all 23 achievements are translated: title, description, hints and the names of the test cases.",
        "The site has moved to daily-coding.dev. Old links to daily-coding.de keep working and lead to the German version.",
        "The legal notice and the privacy policy are available in English as well. The German version remains the authoritative one, and the English page says so.",
